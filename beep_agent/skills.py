...
FUNCTION_SCHEMAS: list[dict[str, Any]] = [
    ...
    {"name": "explore", "description": "Request one bounded guarded exploration lease, then stop and re-perceive.", "parameters": {"type": "object", "required": ["duration_s", "reason"], "properties": {"duration_s": {"type": "number", "minimum": 5, "maximum": 15}, "reason": {"type": "string"}}}},
